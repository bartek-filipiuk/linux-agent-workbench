...
const api = {
  ...
  startRun: (goal: string, opts?: { browserEngine?: "classic" | "jev-hybrid"; profile?: "quick" | "research" | "project"; maxTurns?: number; modelSelection?: ModelSelection; limits?: RunLimits }) => ipcRenderer.invoke("run:start", goal, opts),
