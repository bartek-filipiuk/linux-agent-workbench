...
export type TaskPreferences = { browserEngine: "classic" | "jev-hybrid"; profile: keyof typeof STYLES; stepMode: "unlimited" | "custom"; steps: string; timeMode: "none" | "30" | "60" | "custom"; minutes: string };
...
export function readTaskPreferences(raw: string | null): TaskPreferences {
  try {
    ...
    return { browserEngine: p.browserEngine === "jev-hybrid" ? "jev-hybrid" : "classic", profile: p.profile, stepMode: p.stepMode, steps: p.steps, timeMode: p.timeMode, minutes: p.minutes };
